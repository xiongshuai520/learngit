...
{
    HAL_WriteReg((HI_U32*)IO_ADDRESS( 0x1212007c), 0x55553201);//  ## TDE - MDU -JPGD - IVE -VPSS0-AVC0 - VDP -VI
    HAL_WriteReg((HI_U32*)IO_ADDRESS( 0x12120080), 0x32555632);  //## VPSS2- AVC2-VGS  - AIO -JPGE -VOIE -VPSS1-AVC1
    HAL_WriteReg((HI_U32*)IO_ADDRESS( 0x12120084), 0x66266662);  //## FMC - NFC -DMAC1-DMAC0-USB3 -SATA - A9  -AVC3
    HAL_WriteReg((HI_U32*)IO_ADDRESS( 0x12120088), 0x66666666);  //##  DDRT1-DDRT0-USB2 - SCD - GSF -PCIE1-PCIE0-CIPHER
